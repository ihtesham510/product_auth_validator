...
export function PrizeAssignmentDialog({
    ...
    const selectedPrize = prizeDefinitions?.find(
        (p) => p._id === selectedPrizeId
    );

    const handleAssignPrize = async (values: PrizeAssignmentFormValues) => {
        try {
            await assignPrizeToCode({
                code_id: values.code_id as any,
                prize_definition_id: values.prize_definition_id as any,
            });
            ...
            toast.error(
                err instanceof Error ? err.message : "Failed to assign prize"
            );
        }
    };
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col">
                                    ...
                                    <Popover open={codeComboboxOpen} onOpenChange={setCodeComboboxOpen}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col">
                                    ...
                                    <Popover open={prizeComboboxOpen} onOpenChange={setPrizeComboboxOpen}>
                                        <PopoverTrigger asChild>
                                            <FormControl>
                                                <Button
                                                    variant="outline"
                                        ...
                                        <PopoverContent className="w-full p-0">
                                            <Command>
                                                <CommandInput placeholder="Search prizes..." className="h-9" />
                                                <CommandList>
